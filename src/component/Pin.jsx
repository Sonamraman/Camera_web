...
const Pin = ({open,setOpen}) => {
    ...
    return (
      <div>
        <Dialog open={open}>
          <DialogTitle>
            <Avatar aria-label="close" onClick={handleClose} style={{marginTop:"1vh", marginLeft:"30vw",backgroundColor:"#E02020",height:"5vh",width:"2.5vw"}}>
              <CloseIcon/>
            </Avatar>
          </DialogTitle> 
          <DialogContent>
          ...
          <DialogActions>
            <Button variant="contained" onClick={handleClose} color="primary"
              style={{margin: "0vh 13vw 5vh",height:"4.5vh",width:"8vw",fontSize:"9px",backgroundColor: "#1E82D2",color: "white",}}>
              Submit
            </Button>
          </DialogActions>
        </Dialog>
